export const membershipHomeCopy = {
  eyebrow: "Membership Card",
  title: "Una card digitale per entrare nella community attiva.",
  description:
    "La Membership Card Open Decks identifica chi partecipa al progetto, accede al circuito degli eventi e continua a far parte della rete tra Napoli, Roma, Milano e le prossime tappe.",
  cta: "Maggiori info",
};
...
export const membershipRegulationSections = [
  ...
  {
    title: "3. Assegnazione della Membership",
  ...
  {
    title: "4. Vantaggi della Membership",
  ...
  },
  {
    ...
    items: [
      ...
      "mantenere un comportamento corretto verso staff, pubblico e altri partecipanti",
      "contribuire positivamente all'ambiente Open Decks",
    ],
  },
  {
